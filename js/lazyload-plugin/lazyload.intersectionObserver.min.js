(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global.IntersectionObserver = factory()
})(this, function () {
  "use strict";
...
(function () {
  var cssText = "" + '@charset "utf-8";.progress-images{position:relative;max-width:100%;margin:auto;margin-bottom:1.6rem;}.progress-images--placeholder{width:100%;height:0}.progress-images--canvas{position:absolute;left:0;top:0;width:100%;opacity:1;visibility:visible;transition:visibility 0s linear .5s,opacity .1s .4s; transform: scale(1);}.progress-images--original{position:absolute;left:0;top:0;width:100%;visibility:hidden;opacity:0;}';
...
window.addEventListener("load", function (undefined) {
  ...
  function preloadImage(target) {
    ...
    $img.onload = function () {
      ...
      // reorder: make place-holder to be below img
      var prevNode = target.previousSibling;
      if (prevNode.className.indexOf("progress-images--placeholder") !== -1) {
        var parent = target.parentNode
        parent.removeChild(target)
        parent.insertBefore(target, prevNode)
      }
      $img.onload = null;
      $img = null
    };
